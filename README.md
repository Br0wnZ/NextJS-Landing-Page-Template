...
```
git clone --depth=1 https://github.com/Br0wnZ/NextJS-Landing-Page-Template my-project-name
cd my-project-name
npm install
```
...
[![Netlify Deploy button](https://www.netlify.com/img/deploy/button.svg)](https://github.com/Br0wnZ/NextJS-Landing-Page-Template)
...
Made with ♥ by [Bubulkapp](http://javimoreno.epizy.com/#/)
